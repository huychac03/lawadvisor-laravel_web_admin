...
Route::prefix('lawyer')->name('lawyer.')->group(function () {
    ...
    Route::get('profile/{user_name}/book_appointment', [LawyerProfileController::class, 'bookAppointment'])->name('book_appointment');
});
Route::prefix('law_firm')->name('law_firm.')->group(function () {
    ...
    Route::get('profile/{user_name}/book_appointment', [LawFirmProfileController::class, 'bookAppointment'])->name('book_appointment');
});
