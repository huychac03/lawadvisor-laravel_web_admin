        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                        ...
                        <table id="example1" class="table table-bordered table-striped admin-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($customer->image)
                                        <img src="{{ url($customer->image) }}" width="75px" height="75px" alt="{{ $customer->slug }}">
                                        &nbsp &nbsp
                                        @else
                                        -
                                        @endif
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            {{-- @if(!$customer->is_approved)
                                                        ...
                                                        data-toggle="modal"
                                                        data-target="#approveModal{{ $customer->id }}">
                                            <i class="fa fa-check"></i>
                                            </button>
                                            @endif --}}
                                            <a class="btn btn-primary ml-2 btn-admin" href="{{ route('super_admin.customers.show', ['customer' => $customer->id]) }}"><i class="fa fa-eye"></i></a>
                                            <a class="ml-2 btn btn-secondary btn-admin" href="{{ route('super_admin.customers.edit', ['customer' => $customer->id]) }}"><i class="fa fa-edit"></i></a>
                                            {{-- edit --}}

                                            <button type="button" class="btn btn-danger ml-2 btn-admin" data-toggle="modal" data-target="#deleteModal{{ $customer->id }}">
                    ...
                    <div class="d-flex">
                        {{-- restore --}}
                        <button type="button" class="btn btn-primary ml-2 btn-admin" data-toggle="modal" data-target="#restoreModal{{ $customer->id }}">
                    ...
                    <div class="modal fade" id="deleteModal{{ $customer->id }}" style="display: none;" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Warning</h4>
                                ...
                                <form action="{{ route('super_admin.customers.destroy', ['customer' => $customer->id]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <div class="modal-footer justify-content-between">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    ...
                    <div class="modal fade" id="restoreModal{{ $customer->id }}" style="display: none;" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Warning</h4>
                                ...
                                <form action="{{ route('super_admin.customers.restore', ['customer' => $customer->id]) }}" method="POST">
                                    @csrf
                                    <div class="modal-footer justify-content-between">
                                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
