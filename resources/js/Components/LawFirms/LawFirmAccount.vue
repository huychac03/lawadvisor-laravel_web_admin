      ...
      <div class="row g-0">
        <div class="col-md-3 p-4">
          ...
          >
            ...
            <!-- v-if="hasModule('test')" -->
            <li class="nav-item mb-3" role="presentation" v-if="hasModule('law_firm-social-info', 'law_firm')">
              <button
                class="nav-link w-100 text-dark"
            ...
            <li class="nav-item mb-3" role="presentation" v-if="hasModule('law_firm-certifications', 'law_firm')">
              <button
                class="nav-link w-100 text-dark"
            ...
            <li class="nav-item mb-3" role="presentation" v-if="hasModule('law_firm-broadcasts', 'law_firm')">
              <button
                class="nav-link w-100 text-dark"
            ...
            <li class="nav-item mb-3" role="presentation" v-if="hasModule('law_firm-podcasts', 'law_firm')">
              <button
                class="nav-link w-100 text-dark"
            ...
            <li class="nav-item mb-3" role="presentation" v-if="hasModule('law_firm-events', 'law_firm')">
              <button
                class="nav-link w-100 text-dark"
            ...
            <li class="nav-item mb-3" role="presentation" v-if="hasModule('law_firm-calendly', 'law_firm')">
              <button
                class="nav-link w-100 text-dark"
            ...
            <li class="nav-item mb-3" role="presentation" v-if="hasModule('law_firm-appointment', 'law_firm')">
              <button
                class="nav-link w-100 text-dark"
            ...
            <li class="nav-item mb-3" role="presentation" v-if="hasModule('law_firm-blogs', 'law_firm')">
              <button
                class="nav-link w-100 text-dark"
            ...
            <li class="nav-item mb-3" role="presentation" v-if="hasModule('law_firm-archives', 'law_firm')">
              <button
                class="nav-link w-100 text-dark"
        ...
        <div class="col-md-9 border-start border-dark">
          ...
          <div class="tab-content w-100 p-4" id="v-pills-tabContent">
            ...
            <law-firm-social-info
              v-if="hasModule('law_firm-social-info', 'law_firm') && active_tab == 'social-info'" :active="active_tab == 'social-info'"
            ></law-firm-social-info>
            <law-firm-certifications
              v-if="hasModule('law_firm-certifications', 'law_firm') && active_tab == 'certifications'" :active="active_tab == 'certifications'"
            ></law-firm-certifications>
            <law-firm-lawyers
               :active="active_tab == 'lawyers'"
            ></law-firm-lawyers>
            <law-firm-broadcasts
              v-if="hasModule('law_firm-broadcasts', 'law_firm') && active_tab == 'broadcasts'" :active="active_tab == 'broadcasts'"
            ></law-firm-broadcasts>
            <law-firm-podcasts
              v-if="hasModule('law_firm-podcasts', 'law_firm') && active_tab == 'podcasts'" :active="active_tab == 'podcasts'"
            ></law-firm-podcasts>
            <law-firm-events v-if="hasModule('law_firm-events', 'law_firm') && active_tab == 'events'" :active="active_tab == 'events'"></law-firm-events>
            <law-firm-products
              v-if="hasModule('law_firm-events', 'law_firm') && active_tab == 'products'" :active="active_tab == 'products'"
            ></law-firm-products>
            ...
            ></law-firm-instagram>
            <law-firm-calendly
              v-if="hasModule('law_firm-calendly', 'law_firm') && active_tab == 'calendly'" :active="active_tab == 'calendly'"
            ></law-firm-calendly>
            <law-firm-appointment
              v-if="hasModule('law_firm-appointment', 'law_firm') && active_tab == 'appointment'" :active="active_tab == 'appointment'"
            ></law-firm-appointment>
            <law-firm-posts v-if="hasModule('law_firm-blogs', 'law_firm') && active_tab == 'blogs'" :active="active_tab == 'blogs'"></law-firm-posts>
            <law-firm-archives
              v-if="hasModule('law_firm-archives', 'law_firm') && active_tab == 'archives'" :active="active_tab == 'archives'"
            ></law-firm-archives>
          </div>
        </div>
      </div>
